...
function Dashboard() {
    ...
    return (
        <div className="dash">
                ...
                <div className="parentside">
                    ...
                    <div className="sidebar">
                        ...
                        <div className={main=="products"?"dashgroup custom":"dashgroup"} name="products">
                            ...
                            <button name="products" className="dashbut" onClick={handler}>My products</button>
            ...
            {main == 'upload' ? <PlantsUpload /> : (main == 'user' ? <User /> : (main == 'sold' ? <Sell mysell={sell} /> :(main=='dashboard'?<Charts myplant={plant} myorder={order} />: <CollapsibleTable order={order}  sell={sell} plant={plant}/>)))}
